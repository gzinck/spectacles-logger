...
var TEXT_LOG_POS_HEIGHT_MOD = 0.3;
var TEXT_LOG_CHAR_SCALE = 1.0 / 200.0;
var TEXT_LOG_CAM_DIST = 200.0;

// FOV will depend on spectacles
...
if (global.textLogger == null) {
    var newObject = function(name) {
        ...
        // TODO: set layer to the overlay layer in your project
        // object.setRenderLayer(0); // Set layer to the overlay layer
        return object;
    };
        ...
        for (i = 0; i < l; lines[i++] += line) {
            ...
            while (line.length > intWidth) {
                ...
                if (match[1]) {
                    ...
                    if (!j) {
                        var charsUntilNextWhitespace = (line
                            .slice(intWidth)
                            .match(reBeginningUntilFirstWhitespace) || [""])[0];
    ...
    global.textLogger = (function() {
        ...
        var findComponentRecursive = function(componentType, obj) {
            if (obj == null) {
                for (var i = 0; i < global.scene.getRootObjectsCount(); i++) {
                    var ret = findComponentRecursive(
                        componentType,
        ...
        var resizeRootObject = function() {
            ...
            var hBorder = vBorder * aspect / 2; // divide by 2 for spectacles

            _lastFovOnResize = fov;

            var bottomLeft = new vec3(
                -hBorder,
                -vBorder * TEXT_LOG_POS_HEIGHT_MOD,
                -dist - 0.1
            );
            ...
            _root
                .getTransform()
                .setLocalScale(new vec3(textScale, textScale, textScale));
        ...
        var addLog = function(text, skipConsole) {
            ...
            var ret = global.letterMeshCreator.makeTextObj(
                ">" + text + "\n",
                _pos,
                _holderRoot,
                _maxWidth
